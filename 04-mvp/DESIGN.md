# Design Contract — PM Pipeline Dashboard MVP
...
**Rule:** All color hex values must appear ONLY in `:root` CSS block. No hardcoded colors elsewhere.
...
- **Prototype embed:** Full-width embed with fallback message
